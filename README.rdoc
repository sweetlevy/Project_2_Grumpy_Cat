...
This application was created for General Assembly's Web Development Immersive (WDI) course. This application is currently in development. This project is Project 2 of the WDI course, a Team Project of Team Name "Grumpy Cat". Team Members are: Charlye Brown, Francis Castillo, Sean Jennings Jr and Sarit Levy.
...
- When logged-in:
    ...
    - a user can delete their Stick-IT account
